...
# Cleanup Script for Scenario 2
# Removes Entra ID app registrations and optionally Azure resources

echo "========================================"
echo "Cleanup Scenario 2 Resources"
echo "========================================"
echo ""
...
if [ -z "$CLIENT_ID" ] || [ -z "$API_CLIENT_ID" ]; then
    ...
    echo "Please provide app IDs manually or run: source ./setup-entraid.sh"
    echo ""
...
if [ ! -z "$CLIENT_ID" ]; then
    ...
    echo "✓ Web App registration deleted"
else
